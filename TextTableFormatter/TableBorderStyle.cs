...
namespace TextTableFormatter
{
    ...
    public class TableBordersStyle
    {
        ...
        public static TableBordersStyle HORIZONTAL_ONLY =
            new TableBordersStyle("", "-", " ", "", "", "-", " ", "", "", "-", " ", "", "", " ", "", " ", " ");
        ...
        public static TableBordersStyle CLASSIC_COMPATIBLE =
            new TableBordersStyle("+-++" + "+-++" + "+-++" + "!!!" + "--");
        ...
        public static TableBordersStyle HEAVY_TOP_AND_BOTTOM =
            new TableBordersStyle("+==+" + "+--+" + "+==+" + "|||" + "--");

        public static TableBordersStyle DESIGN_FORMAL =
            new TableBordersStyle("", "=", "=", "", "", "-", " ", "", "", "=", "=", "", "", " ", "", " ", " ");

        public static TableBordersStyle DESIGN_FORMAL_INVERSE =
            new TableBordersStyle("", "-", "-", "", "", "=", " ", "", "", "-", "-", "", "", " ", "", " ", " ");

        public static TableBordersStyle DESIGN_CASUAL =
            new TableBordersStyle("", "=", "=", "", "", "~", " ", "", "", "=", "=", "", "", " ", "", " ", " ");

        public static TableBordersStyle DESIGN_CAFE =
            new TableBordersStyle("", "~", "~", "", "", "~", " ", "", "", "~", "~", "", "", " ", "", " ", " ");

        public static TableBordersStyle DESIGN_SLASH =
            new TableBordersStyle("", "/", "/", "", "", "-", " ", "", "", "/", "/", "", "", " ", "", " ", " ");
        ...
        public static TableBordersStyle DESIGN_CURTAIN = new TableBordersStyle("o~", "~", "~", "~o", "  ", "-", " ",
            "  ", "o~", "~", "~", "~o", "  ", " ", "  ", " ", " ");

        public static TableBordersStyle DESIGN_CURTAIN_HEAVY = new TableBordersStyle("o=", "=", "=", "=o", "  ", "-",
            " ", "  ", "o=", "=", "=", "=o", "  ", " ", "  ", " ", " ");

        public static TableBordersStyle DESIGN_PAPYRUS = new TableBordersStyle("o~~~", "~", "~~", "~~~o", " )  ", "~",
            "  ", "  (", "o~~~", "~", "~~", "~~~o", " )  ", "  ", "  (", "  ", "  ");

        public static TableBordersStyle DESIGN_FORMAL_WIDE =
            new TableBordersStyle("", "=", "==", "", "", "-", "  ", "", "", "=", "==", "", "", "  ", "", "  ", "  ");

        public static TableBordersStyle DESIGN_FORMAL_INVERSE_WIDE =
            new TableBordersStyle("", "-", "--", "", "", "=", "  ", "", "", "-", "--", "", "", "  ", "", "  ", "  ");

        public static TableBordersStyle DESIGN_CASUAL_WIDE =
            new TableBordersStyle("", "=", "==", "", "", "~", "  ", "", "", "=", "==", "", "", "  ", "", "  ", "  ");

        public static TableBordersStyle DESIGN_CAFE_WIDE =
            new TableBordersStyle("", "~", "~~", "", "", "~", "  ", "", "", "~", "~~", "", "", "  ", "", "  ", "  ");

        public static TableBordersStyle DESIGN_SLASH_WIDE =
            new TableBordersStyle("", "/", "//", "", "", "-", "  ", "", "", "/", "//", "", "", "  ", "", "  ", "  ");

        public static TableBordersStyle DESIGN_TUBES_WIDE = new TableBordersStyle(" _", "_", "___", "_ ", "|_", "_",
        ...
        public static TableBordersStyle DESIGN_CURTAIN_WIDE = new TableBordersStyle("o~", "~", "~~", "~o", "  ", "-",
            "  ", "  ", "o~", "~", "~~", "~o", "  ", "  ", "  ", "  ", "  ");

        public static TableBordersStyle DESIGN_CURTAIN_HEAVY_WIDE = new TableBordersStyle("o=", "=", "==", "=o", "  ",
            "-", "  ", "  ", "o=", "=", "==", "=o", "  ", "  ", "  ", "  ", "  ");

        public static TableBordersStyle UNICODE_BOX =
            new TableBordersStyle("\u250c\u2500\u252c\u2510" + "\u251c\u2500\u253c\u2524" + "\u2514\u2500\u2534\u2518" +
                                  "\u2502\u2502\u2502" + "\u2534\u252c");

        public static TableBordersStyle UNICODE_ROUND_BOX =
            new TableBordersStyle("\u256d\u2500\u252c\u256e" + "\u251c\u2500\u253c\u2524" + "\u2570\u2500\u2534\u256f" +
                                  "\u2502\u2502\u2502" + "\u2534\u252c");

        public static TableBordersStyle UNICODE_HEAVY_BOX =
            new TableBordersStyle("\u250f\u2501\u2533\u2513" + "\u2523\u2501\u254b\u252b" + "\u2517\u2501\u253b\u251b" +
                                  "\u2503\u2503\u2503" + "\u253b\u2533");

        public static TableBordersStyle UNICODE_BOX_HEAVY_BORDER =
            new TableBordersStyle("\u250f\u2501\u252f\u2513" + "\u2520\u2500\u253c\u2528" + "\u2517\u2501\u2537\u251b" +
                                  "\u2503\u2502\u2503" + "\u2534\u252c");

        public static TableBordersStyle UNICODE_DOUBLE_BOX =
            new TableBordersStyle("\u2554\u2550\u2566\u2557" + "\u2560\u2550\u256c\u2563" + "\u255a\u2550\u2569\u255d" +
                                  "\u2551\u2551\u2551" + "\u2569\u2566");

        public static TableBordersStyle UNICODE_BOX_DOUBLE_BORDER =
            new TableBordersStyle("\u2554\u2550\u2564\u2557" + "\u255f\u2500\u253c\u2562" + "\u255a\u2550\u2567\u255d" +
                                  "\u2551\u2502\u2551" + "\u2534\u252c");
